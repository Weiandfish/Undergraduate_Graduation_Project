...
\BITSetup{
  ...
  info = {
    ...
    supervisor = 方浩,
    keywords = {视觉—语言—动作模型；Franka机械臂；LeRobot；模仿学习；桌面抓取；$\pi_{0.5}$},
    keywordsEn = {Vision-language-action model; Franka manipulator; LeRobot; imitation learning; desktop grasping; $\pi_{0.5}$},
